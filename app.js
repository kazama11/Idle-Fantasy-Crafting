    ...
    <div class="modal__dialog">
      <div class="modal__card">
        <div class="modal__header">
          <div>
            <div id="wheelModalTitle" class="modal__title">SPIN WHEEL</div>
            <div id="wheelModalSubtitle" class="modal__subtitle">Weighted slices</div>
          </div>
          <div class="modal__actions">
            <button id="wheelModalSpin" class="modal__button modal__button--primary">SPIN</button>
            <button id="wheelModalClose" class="modal__button">Close</button>
          </div>
        </div>
        ...
        <div id="wheelModalResult" class="modal__result"></div>
      </div>
    </div>
  `;
  ...
  el.innerHTML = `
    <div class="fatal-card">
      <div class="fatal-header">
        <div>
          <div class="fatal-title">Living World Wheels failed to start</div>
          <div class="fatal-sub">App ${APP_VERSION} • Schema ${STATE_SCHEMA_VERSION}</div>
        </div>
        <div class="fatal-actions">
          <button id="fatalResetBtn" class="fatal-btn fatal-btn--reset">Reset local data</button>
          <button id="fatalCloseBtn" class="fatal-btn">Close</button>
        </div>
      </div>
      <pre id="fatalStack" class="fatal-stack"></pre>
      <div class="fatal-tip">
